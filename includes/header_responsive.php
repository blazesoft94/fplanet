		...
		<div class="tab-pane " id="chat" role="tabpanel">
			...
			<div class="mCustomScrollbar" data-mcs-theme="dark">
				...
				<ul class="notification-list chat-message">
					...
					<li class="<?php if($message->status =="unread") echo "message-unread" ?>">
						<div class="author-thumb">
		...
		<div class="tab-pane " id="notification" role="tabpanel">
			...
			<div class="mCustomScrollbar" data-mcs-theme="dark">
                ...
                <?php foreach($notifications as $notification){ ?>
					<li>
						<div class="author-thumb">
							<img src="img/<?php echo $notification->sender_image ?>-sm.jpg" alt="author">
						</div>
						<div class="notification-event">
							<div><a href="#" class="h6 notification-friend"><?php echo $notification->sender_name ?></a> <?php echo $notification->text ?> <a href="#" class="notification-link">your post</a>.</div>
							<span class="notification-date"><time class="entry-date updated" datetime="2004-07-24T18:18">4 hours ago</time></span>
						</div>
										<span class="notification-icon">
